...
<head>
    ...
    {* Script exclusivo da página atual, definido pelo controlador PHP. *}
    {if !empty($pagina_script)}
        <script src="{$pagina_script|escape}" defer></script>
    {/if}
</head>
{*
...
<body class="menu-collapsed">
    <div class="app-shell" id="appShell">
        ...
        <main class="main-content" id="conteudoPrincipal">
            {include file=$conteudo_template}
        </main>
    </div>
</body>
</html>
