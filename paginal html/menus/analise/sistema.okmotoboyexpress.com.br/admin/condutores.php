...
switch($acao){
    case 'alterar':
            $pagina->titulo = "Alterar dados do usuario condutores";
            $smarty->assign('pagina',$pagina);                 
            $smarty->display('condutores/formulario.tpl');
            break;	
    case 'cadastrar':
            $pagina->titulo = "Cadastrar usuarios condutores";
            $smarty->assign('pagina',$pagina);
            $smarty->display('condutores/formulario.tpl');
            break;							
    case 'excluir':
            ...
            if($resultado){
                header("Location: ".$pagina->base."condutores");            
            }
    default:
            $pagina->titulo = "Lista de usuarios condutores";
            $smarty->assign('pagina',$pagina);
            $smarty->display('condutores/lista.tpl');
            break;		
}
