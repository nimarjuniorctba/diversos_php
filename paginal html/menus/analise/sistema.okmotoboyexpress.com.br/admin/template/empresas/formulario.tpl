					...
					<form name="form" method="POST" class="formulario">
						...
						<div>
							...
							<div style="display:flex;">
								<label style="width: 140px;"><input type="radio" class="meu_tipo_cad" name="meu_tipo_cad"  value="f" style="margin-right: 2px;" {if $emp_tipo_cadastro=='f'}checked{/if}>Pessoa Físico</label>
								<label><input type="radio" class="meu_tipo_cad" name="meu_tipo_cad"  value="j" style="margin-right: 2px;" {if $emp_tipo_cadastro=='j'}checked{/if}> Pessoa Jurídico</label>
							</div>
						</div>
						{if $pagina->acao=='alterar'}
							<div>
								<label>ID:</label>
								<input type="text" class="form-control" id="emp_id" name="emp_id"  value="{$emp_id|default:''}" style="width:130px;" >
							</div>	
						{/if}						
							...
							<div>
								...
								<div style="display:flex;width:260px;">
									...
									<div style="margin-top: 8px;margin-left: 2px;display:flex;">
										<input type="checkbox" name="emp_pj_ie_isento" value="s" {if isset($emp_pj_ie_isento) && $emp_pj_ie_isento == 's'}checked{/if}>
						...
						<div style="margin-top:30px;">
							<input type="submit" name="submit" value="{$pagina->acao}" id="salvar-nome" class="btn btn-success bg-primary" style="float:right">
						</div>
					</form>
					</div>	
