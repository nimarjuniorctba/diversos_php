<?php
/* Smarty version 4.1.0, created on 2026-06-19 00:12:17
  from 'C:\xampp\htdocs\okmotoboyexpress\sistema.okmotoboyexpress.com.br\admin\template\empresas\formulario.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_6a34b391384b33_26390800',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '68355b50f9069a81634c3d8dfc3a743b8c292c2b' => 
    array (
      0 => 'C:\\xampp\\htdocs\\okmotoboyexpress\\sistema.okmotoboyexpress.com.br\\admin\\template\\empresas\\formulario.tpl',
      1 => 1781838733,
      2 => 'file',
    ),
  ),
...
function content_6a34b391384b33_26390800 (Smarty_Internal_Template $_smarty_tpl) {
					...
					<form name="form" method="POST" class="formulario">
						...
						<div>
							...
							<div style="display:flex;">
								<label style="width: 140px;"><input type="radio" class="meu_tipo_cad" name="meu_tipo_cad"  value="f" style="margin-right: 2px;" <?php if ($_smarty_tpl->tpl_vars['emp_tipo_cadastro']->value == 'f') {?>checked<?php }?>>Pessoa Físico</label>
								<label><input type="radio" class="meu_tipo_cad" name="meu_tipo_cad"  value="j" style="margin-right: 2px;" <?php if ($_smarty_tpl->tpl_vars['emp_tipo_cadastro']->value == 'j') {?>checked<?php }?>> Pessoa Jurídico</label>
							</div>
						</div>
						<?php if ($_smarty_tpl->tpl_vars['pagina']->value->acao == 'alterar') {?>
							<div>
								<label>ID:</label>
								<input type="text" class="form-control" id="emp_id" name="emp_id"  value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['emp_id']->value ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
" style="width:130px;" >
							</div>	
						<?php }?>						
...
" style="margin-right: 5px;">
									<div style="margin-top: 8px;margin-left: 2px;display:flex;">
										<input type="checkbox" name="emp_pj_ie_isento" value="s" <?php if ((isset($_smarty_tpl->tpl_vars['emp_pj_ie_isento']->value)) && $_smarty_tpl->tpl_vars['emp_pj_ie_isento']->value == 's') {?>checked<?php }?>>
...
">
						...
						<div style="margin-top:30px;">
							<input type="submit" name="submit" value="<?php echo $_smarty_tpl->tpl_vars['pagina']->value->acao;?>
" id="salvar-nome" class="btn btn-success bg-primary" style="float:right">
						</div>
					</form>
					</div>	
...
js/formulario/empresas.js"> <?php echo '</script'; ?>
>
