						...
						{if $qte_registros>0}					  
							{foreach $array_clientes item=$clientes}						 
								<tr>
								  ...
								  <td>
									  <a href="{$pagina->base}produtos-categorias/alterar/{$clientes.idurl}"><img src="{$pagina->base}imagens/icones/editar.png" style="width:20px;height:20px;margin-right:5px;cursor: pointer;"></a>
									  <img src="{$pagina->base}imagens/icones/lixo.png" style="width:20px;height:20px;margin-right:10px;cursor: pointer;" class="btn-excluir" data-id="{$clientes.idurl}">
								  </td>
								</tr>
							{/foreach}
						{else}	
