	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light" style="height: 67px;">
		...
		<div class="menu">        
			<ul style="margin-left: 260px;">
				<li>
					<a href="{$pagina->base}home/"><img src="{$pagina->base}imagens/icones/computador_branco.png" style="width:25px;height: 25px;margin-right: 7px;">Home</a>
				</li>			
				<li>
					<a href="{$pagina->base}agenda/"><img src="{$pagina->base}imagens/icones/computador_branco.png" style="width:25px;height: 25px;margin-right: 7px;">Agenda</a>
				</li>				
				...
				<li style="width:123px;">
					...
					<ul>
					   <a href="{$pagina->base}movimentacoes/"><li>Lançamentos</li></a>
					   <a href="{$pagina->base}movimentacoes/"><li>Movimentações</li></a>
					   <a href="{$pagina->base}relatorio/"><li style="color: #fd9a30;font-weight: 600;">Relátorio</li></a>   
					</ul>                
				</li>
				<li>
