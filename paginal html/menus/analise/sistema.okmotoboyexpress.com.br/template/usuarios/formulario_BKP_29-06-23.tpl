						  ...
						  <tbody>
							{if $pagina->acao=='alterar'}
								<tr>
								  ...
								  <td>
									<input type="text" class="form-control" id="usu_id"  value="{$usu_id|default:''}" disabled >
								  </td>
								</tr>
								<tr>
								  <td>Data de cadastro:</td>
								  <td>
									<input type="text" class="form-control" id="usu_dt_cadastro" name="usu_dt_cadastro" value="{$usu_dt_cadastro|default:''}" disabled>
								  </td>
								</tr>
								<tr>
								  <td>Status:</td>
								  <td>
									<input type="text" class="form-control" id="usu_colhida" name="usu_colhida" value="{$usu_status|default:''}" disabled="true">
								  </td>
								</tr>									
							{/if}						
							<tr>
							  ...
							  <td>
								<input type="text" maxlength="100" class="form-control" id="usu_nome" name="usu_nome" value="{$usu_nome|default:''}">
							  </td>
							</tr>
							<tr>
							  <td>E-mail:<span class="text-danger">*</span></td>
							  <td>
								<input type="text" maxlength="255" class="form-control" id="usu_email" name="usu_email" value="{$usu_email|default:''}" >
							  </td>
							</tr>	
							{if $pagina->acao=='alterar'}							
								<tr>
												...
												<table class="table table-bordered" style="width: 92%;margin-left:5%">
													...
													<tbody>
														<tr>
															...
															<td>
																<input type="password" class="form-control" id="usu_senha" name="usu_senha" value="{$usu_senha|default:''}" >
															</td>
														</tr>	
														<tr>
															<td>Confirmar senha:<span class="text-danger">*</span></td>
															<td>
																<input type="password"class="form-control" id="usu_csenha" name="usu_csenha" value="{$usu_csenha|default:''}" >
															</td>
														</tr>
														<tr>
															<td scope="col"  colspan="2">
...
<input type="hidden" id="cartao" value="{$usu_id|default:''}">
