						...
						{if $qte_registros>0}					  
							{foreach $array_clientes item=$clientes}						 
								<tr>
								  ...
								  <td>
									  <a href="{$pagina->base}clientes/alterar/{$clientes.idurl}"><button  class="btn btn-info btn-editar" style="margin-right: 4px;"><i class="medium material-icons" style="font-size: 16px;">create</i></button></a>
									  <button  class="btn btn-danger btn-excluir" data-id="{$clientes.idurl}"><i class="medium material-icons" style="font-size: 16px;">close</i></button>
								  </td>
								</tr>
							{/foreach}
						{else}	
