				...
				{$mensagem|default:''}
					...
					<div class="table-responsive-sm">
						<form name="form" method="POST"  class="formulario">
							...
							<ul class="planos bloco_ped_sistema">
								...
								<li class="anual">
									<span class="linha-1" style="background: #1a3e7b url('{$pagina->base}imagens/icones/etiqueta-planos.png')no-repeat top right;"><input type="radio" checked name="ped_periodo_sistema" value="4"><br><small>Anual</small></span>
					...
					<div class="bloco_ped bloco_ped_website" style="display: none;">
						<div style="display: inline-block; margin-top: 20px;">
							...
							<ul class="planos websites">
								...
								<li class="anual">
									<span class="linha-1" style="background: #464D54 url('{$pagina->base}imagens/icones/imagens/etiqueta-planos.png')no-repeat top right;"><input type="radio" checked name="ped_periodo_website" value="4"><br><small>Anual</small></span>
					...
					<div class="bloco_ped bloco_ped_aplicativo" style="display: none;">
						<div style="display: inline-block; margin-top: 20px;">
							...
							<div style="clear: both;"></div>
							<a href="{$base}aplicativo/" class="link" target="_blank" style="margin-bottom: 10px; font-size: 17px; width: 100%; display: inline-block;text-align: center;color: #294c30; font-weight: bold;">Clique Aqui para saber mais informa&ccedil;&otilde;es sobre o aplicativo!</a>
						</div>
					</div>					
			...
			<div class="bloco_ped_resumo">
					<ul class="planos">
						<li style="margin-left: 26%;">
							...
							<!--{if $existe_setup_android!='s' || $existe_setup_ios!='s'}-->
					...
					<div class="notificacao-alerta atencao valor-taxa-anual-ios" style="display: none; margin-top: 20px!important;">
						<span style="line-height: 20px;">Aten&ccedil;&atilde;o, ser&aacute; necess&aacute;rio pagar anualmente uma taxa de $99 USD para manter o aplicativo na App Store.<br>OBS: Este valor n&atilde;o tem rela&ccedil;&atilde;o com o Quadra F&aacute;cil e n&atilde;o est&aacute; incluso no total do pedido.</span><br>
								...
								<div style="height:auto">
									{include file="formulario_pagamento.tpl"}
								</div>
								...
								<h4>Contrato</h4>	
								<div style="clear:both"></div>								
								<label style="width: 300px;"><input type="checkbox" class="pla_tipo" name="pla_tipo"  value="j"  style="margin-right: 6px;" ><a href="{$pagina->base}contrato/" style="color:rgb(16, 99, 163);">Eu aceito os termos de contrato.</a></label>
								<br>
								<br>
...
<script type="text/javascript" src="{$pagina->base}js/formulario/planos.js"> </script>
