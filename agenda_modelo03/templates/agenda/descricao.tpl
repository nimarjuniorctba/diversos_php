...
<p><strong>Desconto:</strong> R$ {$AG.age_desconto}</p>
<p><strong>Valor Final:</strong> R$ {$AG.age_valor_final}</p>

<hr>

<p><strong>Comentário:</strong><br>{$AG.com_comentario|default:"-"}</p>
